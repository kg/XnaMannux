    ...
    class XNAGraph {
        ...
        public void DrawLine(int x1, int y1, int x2, int y2, byte r, byte g, byte b, byte a) {
            var points = new VertexPositionColor[2] {
                new VertexPositionColor(new Vector3(x1, y1, 0), new Color(r, g, b, a)),
                new VertexPositionColor(new Vector3(x2, y2, 0), new Color(r, g, b, a))
            };
            device.VertexDeclaration = new VertexDeclaration(device, VertexPositionColor.VertexElements);
            device.DrawUserPrimitives<VertexPositionColor>(PrimitiveType.LineList, points, 0, 1);
        }
